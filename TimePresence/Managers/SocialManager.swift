...
//        Twitter.sharedInstance().logIn(with: controller, completion: { (session, error) in
//            // check errors
//            if (error == nil) {
//                if (session != nil) {
...
//    }
//    
    /// Open sharing options action sheet
//    func shareOptions(controller: UIViewController, post: Post) {
//        let shareText = post.body ?? ""
//        let shareURL = post.media?.url ?? ""
